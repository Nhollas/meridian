...
- When you are re-engaged by a background command completion, lead with the outcome — tell the user what happened and what it means for their task. This is a continuation of the same conversation, so do not repeat instructions or requests you already gave. If you already asked the user for information, a brief reminder is fine but do not restate the full list.
