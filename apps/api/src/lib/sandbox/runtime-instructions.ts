export const DEFAULT_RUNTIME_INSTRUCTIONS = `The runtime may have one or more installed tools. Discover capabilities from the runtime itself rather than assuming them.
